...
PARENT_SKILL_PATH = os.path.join(os.path.dirname(SKILL_PATH), "news-aggregator-skill")
...
def generate_report(stdout, sources):
    """Parse stdout and generate a Markdown report."""
...
```json
{stdout[:50000]}  # Truncate to avoid huge output
```
...
def main():
    ...
    report = generate_report(stdout, sources)
