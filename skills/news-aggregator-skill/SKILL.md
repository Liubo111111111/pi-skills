...
description: "Comprehensive news aggregator that fetches, filters, and deeply analyzes real-time content from 9 major sources: Hacker News, GitHub Trending, HuggingFace Papers, Product Hunt, 36Kr, Tencent News, WallStreetCN, V2EX, and Weibo. Best for 'daily scans', 'tech news briefings', 'finance updates', and 'deep interpretations' of hot topics."
---
...
- `--source`: One of `hackernews`, `weibo`, `github`, `huggingface`, `36kr`, `producthunt`, `v2ex`, `tencent`, `wallstreetcn`, `all`.
