...
description: "提取网页正文并转换为 Markdown。当用户明确要原文、正文、Markdown、源码式提取、网页转 Markdown、保存抓取结果、提取 ChatGPT/Gemini/Grok 对话时使用。对于 X/Twitter 场景，优先在用户明确要“原文/正文/markdown/提取结果”时触发；如果用户只是贴 X 链接并想知道这条内容讲了什么、要中文总结或快报，优先使用 x-brief-cn。"
...
### 用户还要中文总结/简报
→ 提取完成后，不要停在“抓取成功”；继续交给中文摘要流程或 `x-brief-cn`
